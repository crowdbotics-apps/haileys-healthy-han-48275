"""
Django settings for haileys_healthy_han_48275 project.
...
ROOT_URLCONF = 'haileys_healthy_han_48275.urls'
...
WSGI_APPLICATION = 'haileys_healthy_han_48275.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "haileys_healthy_han_48275 API",
    "DESCRIPTION": "API documentation for haileys_healthy_han_48275 App",
    "VERSION": "v1",
}
